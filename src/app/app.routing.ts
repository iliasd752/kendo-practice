    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'dashboards', children: [
                ...
                {path: 'posts', loadChildren: () => import('app/modules/admin/dashboards/posts/posts.module').then(m => m.PostsModule)},
                {path: 'photos', loadChildren: () => import('app/modules/admin/dashboards/photos/photos.module').then(m => m.PhotosModule)},
                {path: 'comments', loadChildren: () => import('app/modules/admin/dashboards/comments/comment.module').then(m => m.CommentModule)},
            ]},
